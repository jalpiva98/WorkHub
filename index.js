...
function hideModal() {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    // Listen to the "Search Jobs" button click
    document.getElementById('searchButton').addEventListener('click', function () {
      const position = $('#positionInputID').val();
      const skills = $('#skillInputID').val();
      const city = $('#locationInputID').val();
  
      // Call the fetchJobSearch function with the input values
      fetchJobSearch(position, skills, city);
    });
  
    // Rest of your JavaScript code...
  
    // Remove the 'inputFunc()' function call from the global scope
  });
